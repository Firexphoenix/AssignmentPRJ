...
<html lang="en">
    <head>
        ...
        <title>Chỉnh sửa phim - THVB Cinema</title>
        <!-- Bootstrap 5 CSS -->
        ...
        <div class="form-container">
            ...
            <form action="<%= request.getContextPath()%>/movies" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="movieTitle" name="movieTitle" value="${movie.movieTitle}" required>
                </div>

                <div class="mb-3">
                    <label for="movieGenre" class="form-label">Thể loại <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="movieGenre" name="movieGenre" value="${movie.movieGenre}" required>
                </div>

                <div class="mb-3">
                    <label for="releaseDate" class="form-label">Ngày phát hành</label>
                    <input type="date" class="form-control" id="releaseDate" name="releaseDate" value="<fmt:formatDate value='${movie.releaseDate}' pattern='yyyy-MM-dd'/>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="movieDuration" name="movieDuration" value="${movie.movieDuration}" required min="1">
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100">Cập nhật phim</button>
            </form>
